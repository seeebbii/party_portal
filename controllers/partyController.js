...
// router.post('/create', upload.array("partyImages", 5), async (req, res, next) => {
...
//         res.status(200).json({ message: "Party deletd", partyId: result._id, success: true });
//     }).catch(err => {
//         res.status(500).json({ error: err, success: false });
//     });
// }
...
// exports.joinParty = (req, res, next) => {
...
// exports.bidOnParty = async function(req, res, next) {
...
// exports.highestBid = async function(req, res, next) {
//     const partyId = req.params.partyId;
